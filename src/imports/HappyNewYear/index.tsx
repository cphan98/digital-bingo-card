import svgPaths from "./svg-yoincqvt97";
...
import imgCheers1 from "./32babbf94dfe1f4a89a87957ee9cd1bab158913a.png";
...
function PopUpTitle() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="pop up title">
      <p className="[word-break:break-word] font-['Quicksand:Bold',sans-serif] font-bold leading-[26px] relative shrink-0 text-[#2b2b23] text-[16px] text-center w-full">Happy New Year!</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[15px] items-center relative shrink-0 w-full">
      <div className="relative shrink-0 size-[70px]" data-name="cheers 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgCheers1} />
      </div>
      <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[20px] min-w-full relative shrink-0 text-[#2b2b23] text-[12px] text-center w-[min-content]">{`We've saved a snapshot of your old board to your device, and your new grid is ready to go!`}</p>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#657652] flex-[1_0_0] min-w-px relative rounded-[100px]" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center justify-center px-[14px] py-[6px] relative size-full">
          <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[18px] relative shrink-0 text-[#faf6f0] text-[12px] text-center whitespace-nowrap">Let’s Begin!</p>
        </div>
      </div>
    </div>
  );
...
function ButtonsContainer2() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[20px] relative shrink-0 w-full" data-name="buttons container">
      <ButtonContainer2 />
    </div>
  );
}
...
function PopUpContainer() {
  return (
    <div className="bg-white relative rounded-[14px] shrink-0 w-[226px]" data-name="pop up container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[10px] items-end pb-[25px] pt-[13px] px-[13px] relative size-full">
        <ExitButton />
        <PopUpTitle />
        <Frame />
        <ButtonsContainer2 />
...
export default function HappyNewYear() {
  return (
    <div className="bg-[#faf6f0] relative size-full" data-name="Happy New Year">
      <AppContainer />
      <PopUp />
    </div>
  );
