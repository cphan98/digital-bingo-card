import svgPaths from "./svg-xgeefh4b9n";
...
import imgChange1 from "./825eb0f54b16011718720b1b49ec50b897e059cb.png";
    ...
    <div className="absolute left-[36px] size-[6px] top-[4.01px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="6" preserveAspectRatio="none" viewBox="0 0 6 6" width="6">
        <g clipPath="url(#clip0_0_18)" id="Icon">
          <path d="M3 5H5.25" id="Vector" stroke="#94BEBB" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.5" />
          <path d={svgPaths.p3c129a00} id="Vector_2" stroke="#94BEBB" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.5" />
        </g>
        <defs>
    ...
    <div className="flex-[1_0_0] min-w-px relative rounded-[100px]" data-name="Button">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center justify-center px-[14px] py-[6px] relative size-full">
          <div className="relative shrink-0 size-[10px]" data-name="change 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgChange1} />
          </div>
          <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[18px] relative shrink-0 text-[#657652] text-[10px] text-center whitespace-nowrap">Shuffle</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 size-[10px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="10" preserveAspectRatio="none" viewBox="0 0 10 10" width="10">
        <g clipPath="url(#clip0_0_21)" id="Icon">
          <path d={svgPaths.p2887be00} id="Vector" stroke="#FEFDF7" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.9" />
          <path d={svgPaths.p1053e400} id="Vector_2" stroke="#FEFDF7" strokeWidth="0.9" />
          <path d={svgPaths.p30eef500} id="Vector_3" stroke="#FEFDF7" strokeWidth="0.9" />
        </g>
        <defs>
...
function Button3() {
  return (
    <div className="relative rounded-[100px] shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center justify-center px-[14px] py-[4px] relative size-full">
        <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[18px] relative shrink-0 text-[#23617e] text-[10px] text-center whitespace-nowrap">New Card</p>
      </div>
    </div>
  );
}
        ...
        <div className="-rotate-90 flex-none w-[100cqh]">
          <div className="h-0 relative w-full">
            <div className="absolute inset-[-1px_0_0_0]">
              <svg className="block size-full" fill="none" height="1" preserveAspectRatio="none" viewBox="0 0 26 1" width="26">
                <line id="Line 1" stroke="#F1E8D7" strokeLinecap="round" x1="0.5" x2="25.5" y1="0.5" y2="0.5" />
              </svg>
            </div>
          </div>
        </div>
...
function App() {
  return (
    <div className="absolute bg-[#faf6f0] content-stretch flex flex-col h-[606px] items-center justify-center left-0 pb-[71.016px] pt-[59px] px-[12px] right-0 top-0" data-name="App">
      <BingoContainer />
    </div>
  );
}
...
function PopUpTitle() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="pop up title">
    ...
    <div className="h-[120px] relative rounded-[10px] shrink-0 w-full" data-name="Text Area">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start px-[16px] py-[12px] relative size-full">
          <p className="[word-break:break-word] font-['Quicksand:Medium',sans-serif] font-medium leading-[26px] relative shrink-0 text-[#2b2b23] text-[14px] text-center whitespace-nowrap">Read 10 books</p>
        </div>
      </div>
...
function Button4() {
  return (
    <div className="flex-[1_0_0] min-w-px relative rounded-[100px]" data-name="Button">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center justify-center px-[14px] py-[6px] relative size-full">
          <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#94bebb] text-[12px] text-center whitespace-nowrap">Not yet</p>
        </div>
      </div>
    </div>
  );
...
function Button5() {
  return (
    <div className="bg-[rgba(101,118,82,0.15)] flex-[1_0_0] min-w-px relative rounded-[100px]" data-name="Button">
      <div aria-hidden className="absolute border border-[#657652] border-solid inset-0 pointer-events-none rounded-[100px]" />
      <div className="flex flex-row items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center justify-center px-[14px] py-[6px] relative size-full">
          <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#657652] text-[12px] text-center whitespace-nowrap">Yes!</p>
        </div>
      </div>
    </div>
  );
...
function ButtonsContainer2() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="buttons container">
      <ButtonContainer4 />
      <ButtonContainer5 />
    </div>
  );
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-[200px]">
      <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[20px] min-w-full relative shrink-0 text-[#2b2b23] text-[14px] w-[min-content]">Have you completed this resolution?</p>
      <ButtonsContainer2 />
    </div>
  );
}
...
function TextArea1() {
  return (
    <div className="relative rounded-[10px] shrink-0 w-full" data-name="Text Area">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start px-[10px] py-[4px] relative size-full">
          <p className="[word-break:break-word] font-['Quicksand:Medium',sans-serif] font-medium leading-[26px] relative shrink-0 text-[#2b2b23] text-[14px] text-center whitespace-nowrap">DD-MM-YYYY</p>
        </div>
      </div>
      <div aria-hidden className="absolute border-[#f1e8d7] border-[1.5px] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-[200px]">
      <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[20px] min-w-full relative shrink-0 text-[#2b2b23] text-[14px] w-[min-content]">Completion date</p>
      <TextArea1 />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[11px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="11" preserveAspectRatio="none" viewBox="0 0 11 11" width="11">
        <g id="Icon">
          <path d="M1.5 5.5L4.5 8.5L9.5 2.5" id="Vector" stroke="#FEFDF7" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" />
        </g>
      </svg>
    </div>
  );
...
function ButtonsContainer3() {
  return (
    <div className="content-stretch flex gap-[12px] items-start justify-center pt-[20px] relative shrink-0 w-full" data-name="buttons container">
      <ButtonContainer6 />
    </div>
  );
}
...
export default function EditPromptYes() {
  return (
    <div className="bg-[#faf6f0] relative size-full" data-name="Edit Prompt (Yes)">
      <App />
      <PopUp />
    </div>
  );
