import svgPaths from "./svg-m5zptobfhz";
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15px] items-center left-[24px] right-[24px] top-[70px]">
      ...
      <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[20px] min-w-full relative shrink-0 text-[#2b2b23] text-[12px] text-center w-[min-content]">This will permanently erase your current grid.</p>
    </div>
  );
}
