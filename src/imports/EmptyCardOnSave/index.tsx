import svgPaths from "./svg-rxg5d1a2fb";
...
function Paragraph1() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-w-px relative" data-name="Paragraph">
  ...
  return (
    <div className="absolute left-[36px] size-[6px] top-[4.01px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
        <g clipPath="url(#clip0_60_1797)" id="Icon">
...
function Paragraph2() {
  return (
    <div className="flex-[1_0_0] h-[27px] min-w-px relative" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center relative size-full" />
    </div>
  );
}
...
function Paragraph22() {
  return (
    <div className="flex-[1_0_0] h-[9px] min-w-px relative" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center relative size-full" />
    </div>
  );
}
...
export default function EmptyCardOnSave() {
  return (
    <div className="relative size-full" data-name="Empty Card on Save">
      <App />
      <PopUp />
    </div>
  );
