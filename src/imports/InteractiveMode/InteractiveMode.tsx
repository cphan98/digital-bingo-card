import svgPaths from "./svg-5r48ucxh72";

function Icon() {
  return (
    <div className="h-[24px] relative shrink-0 w-[20.75px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.75 24">
        <g id="Icon">
          <path d={svgPaths.p2d107e00} fill="var(--fill-0, #F4D892)" id="Vector" stroke="var(--stroke-1, #F4D892)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.72917" />
          <path d="M17.2917 4.21875V7.67708" id="Vector_2" stroke="var(--stroke-0, #F4D892)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.72917" />
          <path d="M19.0208 5.94792H15.5625" id="Vector_3" stroke="var(--stroke-0, #F4D892)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.72917" />
          <path d="M3.45833 16.3229V18.0521" id="Vector_4" stroke="var(--stroke-0, #F4D892)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.72917" />
          <path d="M4.32292 17.1875H2.59375" id="Vector_5" stroke="var(--stroke-0, #F4D892)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.72917" />
        </g>
      </svg>
    </div>
  );
...
function Heading() {
  return (
    <div className="h-[86px] relative shrink-0 w-[148px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full text-center">
...
function Icon1() {
  return (
    <div className="h-[24px] relative w-[20.75px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.75 24">
        <g id="Icon">
          <path d={svgPaths.p3df08f40} fill="var(--fill-0, #F4D892)" id="Vector" stroke="var(--stroke-1, #F4D892)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.72917" />
          <path d="M17.2917 4.21875V7.67708" id="Vector_2" stroke="var(--stroke-0, #F4D892)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.72917" />
          <path d="M19.0208 5.94792H15.5625" id="Vector_3" stroke="var(--stroke-0, #F4D892)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.72917" />
          <path d="M3.45833 16.3229V18.0521" id="Vector_4" stroke="var(--stroke-0, #F4D892)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.72917" />
          <path d="M4.32292 17.1875H2.59375" id="Vector_5" stroke="var(--stroke-0, #F4D892)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.72917" />
...
function Paragraph() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute font-['Quicksand:Medium',sans-serif] font-medium leading-[18px] left-[127.98px] text-[#657652] text-[10px] text-center top-0 whitespace-nowrap">Click squares to mark them complete</p>
    </div>
  );
}
  ...
  return (
    <div className="flex-[1_0_0] min-w-px relative" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center relative size-full">
        <div className="flex flex-col font-['Quicksand:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#2b2b23] text-[7.5px] text-center w-full">
...
function Icon2() {
  return (
    <div className="h-[45px] relative w-[39px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 39 45">
        <g clipPath="url(#clip0_12_1313)" id="Icon">
          <path d={svgPaths.p3d40f580} fill="var(--fill-0, #F2B6A3)" id="Vector" stroke="var(--stroke-1, #F2B6A3)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.72917" />
          <path d={svgPaths.p258d9bf0} fill="var(--fill-0, #F2B6A3)" id="Vector_2" stroke="var(--stroke-1, #F2B6A3)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.72917" />
        </g>
        <defs>
...
function Square24() {
  return (
    <div className="aspect-[46.400001525878906/46.400001525878906] bg-[#fefdf7] col-5 justify-self-stretch relative rounded-[4px] row-5 shrink-0" data-name="square">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[5px] relative size-full">
          <Container24 />
        </div>
  ...
  return (
    <div className="relative rounded-[100px] shrink-0" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[8px] py-[4px] relative size-full">
        <Icon3 />
        <p className="font-['Quicksand:Medium',sans-serif] font-medium leading-[18px] relative shrink-0 text-[#657652] text-[10px] text-center whitespace-nowrap">Edit</p>
      </div>
    </div>
  );
}
...
function Icon4() {
  return (
    <div className="relative shrink-0 size-[10px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
        <g clipPath="url(#clip0_12_1324)" id="Icon">
  ...
  return (
    <div className="relative rounded-[100px] shrink-0" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center justify-center px-[8px] py-[4px] relative size-full">
        <Icon4 />
        <p className="font-['Quicksand:Medium',sans-serif] font-medium leading-[18px] relative shrink-0 text-[#657652] text-[10px] text-center whitespace-nowrap">Export</p>
      </div>
    </div>
  );
}
...
function ButtonsContainer() {
  return (
    <div className="content-stretch flex gap-[12px] h-[92px] items-start justify-center relative shrink-0 w-[256px]" data-name="buttons container">
      <ButtonContainer />
      <ButtonContainer1 />
    </div>
  );
