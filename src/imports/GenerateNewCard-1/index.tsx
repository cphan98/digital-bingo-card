import svgPaths from "./svg-aa15ml46um";
...
function ExitButton() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="exit button">
      <CloseIcon />
    </div>
  );
}
...
function ButtonsContainer2() {
  return (
    <div className="content-stretch flex items-center justify-between pt-[20px] relative shrink-0 w-[200px]" data-name="buttons container">
      <ButtonContainer4 />
      <ButtonContainer5 />
    </div>
  );
