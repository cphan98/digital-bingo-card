import svgPaths from "./svg-5h6ormebh5";
  ...
  return (
    <div className="absolute left-[36px] size-[6px] top-[4.01px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
        <g clipPath="url(#clip0_78_284)" id="Icon">
...
export default function EditMode() {
  return (
    <div className="bg-[#faf6f0] content-stretch flex flex-col items-start relative size-full" data-name="Edit Mode">
      <App />
    </div>
  );
}