import svgPaths from "./svg-q19sjbc3kk";
...
function Grid() {
  return (
    <div className="gap-x-[6px] gap-y-[8px] grid grid-cols-[repeat(5,minmax(0,1fr))] grid-rows-[repeat(5,fit-content(100%))] relative shrink-0 w-[256px]" data-name="grid">
      <Square />
      <button className="bg-[#fefdf7] col-1 cursor-pointer relative rounded-[4px] row-1 shrink-0 size-[46.4px]" data-name="grid square">
      ...
      <button className="bg-[#fefdf7] col-2 cursor-pointer relative rounded-[4px] row-1 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container1 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-3 cursor-pointer relative rounded-[4px] row-1 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container2 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-4 cursor-pointer relative rounded-[4px] row-1 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container3 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-5 cursor-pointer relative rounded-[4px] row-1 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container4 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-1 cursor-pointer relative rounded-[4px] row-2 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container5 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-2 cursor-pointer relative rounded-[4px] row-2 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container6 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-3 cursor-pointer relative rounded-[4px] row-2 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container7 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-4 cursor-pointer relative rounded-[4px] row-2 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container8 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-5 cursor-pointer relative rounded-[4px] row-2 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container9 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-1 cursor-pointer relative rounded-[4px] row-3 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container10 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-2 cursor-pointer relative rounded-[4px] row-3 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container11 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-4 cursor-pointer relative rounded-[4px] row-3 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container12 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-5 cursor-pointer relative rounded-[4px] row-3 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container13 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-1 cursor-pointer relative rounded-[4px] row-4 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container14 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-2 cursor-pointer relative rounded-[4px] row-4 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container15 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-3 cursor-pointer relative rounded-[4px] row-4 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container16 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-5 cursor-pointer relative rounded-[4px] row-5 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container17 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-4 cursor-pointer relative rounded-[4px] row-4 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container18 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-2 cursor-pointer relative rounded-[4px] row-5 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container19 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-1 cursor-pointer relative rounded-[4px] row-5 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container20 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-3 cursor-pointer relative rounded-[4px] row-5 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container21 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-4 cursor-pointer relative rounded-[4px] row-5 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container22 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </button>
      <button className="bg-[#fefdf7] col-5 cursor-pointer relative rounded-[4px] row-4 shrink-0 size-[46.4px]" data-name="grid square">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
          <Container23 />
        </div>
        <div aria-hidden className="absolute border border-[#f1e8d7] border-solid inset-0 pointer-events-none rounded-[4px]" />
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[10px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
        <g clipPath="url(#clip0_75_785)" id="Icon">
          <path d={svgPaths.p1ab95b80} id="Vector" stroke="var(--stroke-0, #FAF6F0)" strokeLinecap="round" strokeLinejoin="round" />
          <path d={svgPaths.p1f22680} id="Vector_2" stroke="var(--stroke-0, #FAF6F0)" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M5 1.25V6.25" id="Vector_3" stroke="var(--stroke-0, #FAF6F0)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
  ...
  return (
    <div className="bg-[#657652] flex-[1_0_0] min-w-px relative rounded-[100px]" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center justify-center px-[14px] py-[6px] relative size-full">
          <Icon1 />
          <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[18px] relative shrink-0 text-[#faf6f0] text-[10px] text-center whitespace-nowrap">Export</p>
        </div>
      </div>
    </div>
  );
...
export default function InteractiveMode() {
  return (
    <div className="bg-[#faf6f0] content-stretch flex flex-col items-start relative size-full" data-name="Interactive Mode">
      <AppContainer />
    </div>
  );
}