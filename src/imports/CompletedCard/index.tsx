import svgPaths from "./svg-b1xfaq8tub";
...
import imgMedal1 from "./8362ac86e1d54d5cbce2a8f24381508d57275961.png";
  ...
  return (
    <div className="absolute h-[38.907px] left-[3.06px] opacity-90 top-[3.06px] w-[38.914px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 38.9136 38.9073">
        <g id="Group 2">
          <path d={svgPaths.p31e2fa00} id="Ellipse 1" stroke="var(--stroke-0, #FEFDF7)" strokeLinecap="round" strokeWidth="2" />
          <path d={svgPaths.p1e3d17f0} fill="var(--fill-0, #FEFDF7)" id="DD/MM/YY" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[213.06px] mt-[221.06px] place-items-start relative row-1">
      <div className="col-1 h-[17.571px] ml-[218.28px] mt-[237.18px] relative row-1 w-[28.475px]">
        <div className="absolute inset-[-5.69%_-3.51%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30.4753 19.5708">
            <path d={svgPaths.p1ea67400} id="Ellipse 1" stroke="var(--stroke-0, #FEFDF7)" strokeLinecap="round" strokeWidth="2" />
          </svg>
        </div>
      </div>
    </div>
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[10px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
        <g clipPath="url(#clip0_84_902)" id="Icon">
...
function PopUpTitle() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[24px] right-[24px] top-[24px]" data-name="pop up title">
      <p className="[word-break:break-word] font-['Quicksand:Bold',sans-serif] font-bold leading-[26px] relative shrink-0 text-[#2b2b23] text-[16px] text-center w-full">BINGO! Full House!</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15px] items-center left-[24px] right-[24px] top-[70px]">
      <div className="relative shrink-0 size-[70px]" data-name="medal 1">
...
function ButtonsContainer2() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[24px] right-[24px] top-[223px]" data-name="buttons container">
      <ButtonContainer2 />
    </div>
  );
}
