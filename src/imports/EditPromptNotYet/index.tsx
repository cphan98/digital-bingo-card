import svgPaths from "./svg-16ppvlwbde";
...
function Button4() {
  return (
    <div className="bg-[rgba(242,182,163,0.15)] flex-[1_0_0] min-w-px relative rounded-[100px]" data-name="Button">
      <div aria-hidden className="absolute border border-[#e89c73] border-solid inset-0 pointer-events-none rounded-[100px]" />
      <div className="flex flex-row items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center justify-center px-[14px] py-[6px] relative size-full">
          <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#e89c73] text-[12px] text-center whitespace-nowrap">Not yet</p>
        </div>
      </div>
    </div>
  );
...
function Button5() {
  return (
    <div className="flex-[1_0_0] min-w-px relative rounded-[100px]" data-name="Button">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center justify-center px-[14px] py-[6px] relative size-full">
          <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#94bebb] text-[12px] text-center whitespace-nowrap">Yes!</p>
        </div>
      </div>
    </div>
  );
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-[200px]">
      <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[20px] min-w-full relative shrink-0 text-[#2b2b23] text-[12px] w-[min-content]">Have you completed this resolution?</p>
      <ButtonsContainer2 />
    </div>
  );
}
...
export default function EditPromptNotYet() {
  return (
    <div className="bg-[#faf6f0] relative size-full" data-name="Edit Prompt (Not yet)">
      <App />
      <PopUp />
    </div>
  );
