import svgPaths from "./svg-c4j2u2dewd";
...
import imgMagicWand1 from "./af03c8e7e08139d7be443b3d19eba32723da91d6.png";
  ...
  return (
    <div className="absolute left-[36px] size-[6px] top-[4.01px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
        <g clipPath="url(#clip0_91_326)" id="Icon">
  ...
  return (
    <div className="relative shrink-0 size-[10px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
        <g clipPath="url(#clip0_75_1031)" id="Icon">
          <path d={svgPaths.p2887be00} id="Vector" stroke="var(--stroke-0, #FEFDF7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.9" />
          <path d={svgPaths.p1053e400} id="Vector_2" stroke="var(--stroke-0, #FEFDF7)" strokeWidth="0.9" />
          <path d={svgPaths.p30eef500} id="Vector_3" stroke="var(--stroke-0, #FEFDF7)" strokeWidth="0.9" />
        </g>
        <defs>
          ...
          <div className="h-0 relative w-full">
            <div className="absolute inset-[-1px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26 1">
                <line id="Line 1" stroke="var(--stroke-0, #F1E8D7)" strokeLinecap="round" x1="0.5" x2="25.5" y1="0.5" y2="0.5" />
              </svg>
            </div>
          </div>
        </div>
...
function PopUpTitle() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[24px] right-[24px] top-[24px]" data-name="pop up title">
      <p className="[word-break:break-word] font-['Quicksand:Bold',sans-serif] font-bold leading-[26px] relative shrink-0 text-[#2b2b23] text-[16px] text-center w-full">Generate a new card?</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15px] items-center left-[24px] pt-[20px] right-[24px] top-[50px]">
      <div className="relative shrink-0 size-[70px]" data-name="magic-wand 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgMagicWand1} />
      </div>
      <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[0] min-w-full relative shrink-0 text-[#2b2b23] text-[12px] text-center w-[min-content]">
        <span className="leading-[20px]">{`This will replace your current board with 24 randomly selected resolutions. `}</span>
        <span className="font-['Quicksand:Bold',sans-serif] font-bold leading-[20px]">All progress will be lost.</span>
      </p>
    </div>
  );
}
...
function Button4() {
  return (
    <div className="relative rounded-[100px] shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[14px] py-[6px] relative size-full">
  ...
  return (
    <div className="bg-[#657652] relative rounded-[100px] shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[6px] relative size-full">
        <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#faf6f0] text-[12px] text-center whitespace-nowrap">Generate</p>
      </div>
    </div>
  );
}
...
function ButtonsContainer2() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[24px] pt-[28px] right-[24px] top-[223px]" data-name="buttons container">
      <ButtonContainer4 />
      <ButtonContainer5 />
    </div>
  );
...
function CloseIcon() {
  return (
    <div className="absolute aspect-[20/20] left-0 overflow-clip right-0 top-0" data-name="CloseIcon">
...
function ExitButton() {
  return (
    <div className="absolute left-[219px] size-[16px] top-[13px]" data-name="exit button">
      <CloseIcon />
    </div>
  );
}
...
function PopUpContainer() {
  return (
    <div className="bg-white h-[302px] relative rounded-[14px] shrink-0 w-[248px]" data-name="pop up container">
...
export default function GenerateNewCard() {
  return (
    <div className="bg-[#faf6f0] relative size-full" data-name="Generate New Card">
      <App />
      <PopUp />
    </div>
  );
