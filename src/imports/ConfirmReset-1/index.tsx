import svgPaths from "./svg-gdymwtvmm6";
...
import imgThrowingTrash1 from "./4c9d57a6d3c0444fd0df5a71aebcabd1464247a0.png";
  ...
  return (
    <div className="absolute left-[36px] size-[6px] top-[4.01px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
        <g clipPath="url(#clip0_55_1537)" id="Icon">
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15px] items-center left-[24px] right-[24px] top-[70px]">
      <div className="relative shrink-0 size-[70px]" data-name="throwing-trash 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgThrowingTrash1} />
      </div>
