import svgPaths from "./svg-3fgu51cdny";
...
import imgDustbin1 from "./61b75fdf868b1da311ee535cde3ac2897aed0d4e.png";
...
function PopUpTitle() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[24px] right-[24px] top-[24px]" data-name="pop up title">
      <p className="[word-break:break-word] font-['Quicksand:Bold',sans-serif] font-bold leading-[26px] relative shrink-0 text-[#2b2b23] text-[16px] text-center w-full">Clear all prompts?</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15px] items-center left-[24px] right-[24px] top-[70px]">
      <div className="relative shrink-0 size-[70px]" data-name="dustbin 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgDustbin1} />
      </div>
      <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[0] min-w-full relative shrink-0 text-[#2b2b23] text-[12px] text-center w-[min-content]">
        <span className="leading-[20px]">{`This will permanently erase your grid. `}</span>
...
function Button5() {
  return (
    <div className="bg-[#e36559] relative rounded-[100px] shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[6px] relative size-full">
        <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#2b2b23] text-[12px] text-center whitespace-nowrap">Clear all</p>
      </div>
    </div>
  );
}
...
function ButtonsContainer2() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[24px] right-[24px] top-[223px]" data-name="buttons container">
      <ButtonContainer4 />
      <ButtonContainer5 />
    </div>
  );
...
function PopUpContainer() {
  return (
    <div className="bg-white h-[275px] relative rounded-[14px] shrink-0 w-[248px]" data-name="pop up container">
...
export default function ConfirmReset() {
  return (
    <div className="bg-[#faf6f0] relative size-full" data-name="Confirm Reset">
      <App />
      <PopUp />
    </div>
  );
