import svgPaths from "./svg-x3bicad9xy";
...
import imgCheck1 from "./801185b752c3398d087ddda436df8a5c764edda0.png";
  ...
  return (
    <div className="absolute left-[36px] size-[6px] top-[4.01px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
        <g clipPath="url(#clip0_84_570)" id="Icon">
...
function ButtonContainer() {
  return (
    <div className="h-[26px] relative shrink-0 w-full" data-name="button container">
...
function PopUpTitle() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[24px] right-[24px] top-[24px]" data-name="pop up title">
      <p className="[word-break:break-word] font-['Quicksand:Bold',sans-serif] font-bold leading-[26px] relative shrink-0 text-[#2b2b23] text-[16px] text-center w-full">Incomplete bingo card</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15px] items-center left-[24px] pt-[20px] right-[24px] top-[50px]">
      <div className="relative shrink-0 size-[70px]" data-name="check 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgCheck1} />
      </div>
      <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[20px] min-w-full relative shrink-0 text-[#2b2b23] text-[12px] text-center w-[min-content]">You still have some empty squares! Please fill in all the prompts before saving.</p>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="bg-[#657652] flex-[1_0_0] min-w-px relative rounded-[100px]" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center justify-center px-[14px] py-[6px] relative size-full">
          <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#fefdf7] text-[12px] text-center whitespace-nowrap">Let’s finish it!</p>
        </div>
      </div>
    </div>
  );
...
function ButtonsContainer2() {
  return (
    <div className="absolute content-stretch flex h-[56px] items-center justify-center left-[24px] pt-[28px] right-[24px] top-[215px]" data-name="buttons container">
      <ButtonContainer3 />
    </div>
  );
}
...
function PopUpContainer() {
  return (
    <div className="bg-white h-[295px] relative rounded-[14px] shrink-0 w-[248px]" data-name="pop up container">
...
export default function EmptyCardOnSave() {
  return (
    <div className="bg-[#faf6f0] relative size-full" data-name="Empty Card on Save">
      <App />
      <PopUp />
    </div>
  );
