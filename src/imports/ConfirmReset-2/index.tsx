import svgPaths from "./svg-18gi7s5hbq";
...
import imgTrashCan from "./28a6ebfb11ad8956bc5f28462116e5f48e177f09.png";
  ...
  return (
    <div className="absolute left-[36px] size-[6px] top-[4.01px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
        <g clipPath="url(#clip0_72_326)" id="Icon">
...
function TrashCan() {
  return (
    <div className="overflow-clip relative shrink-0 size-[70px]" data-name="trash can">
      <img alt="" className="absolute block inset-0 max-w-none size-full" height="70" src={imgTrashCan} width="70" />
      <div className="absolute inset-[78.62%_87.21%_10.64%_12.79%]" data-name="Vector">
        <div className="absolute inset-[-20.94%_-1.58px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3.15 10.672">
            <path d="M1.575 9.097V1.575" id="Vector" stroke="var(--stroke-0, #E36559)" strokeLinecap="round" strokeWidth="3.15" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[7.27%_21.3%_85.14%_71.11%]" data-name="Vector">
        <div className="absolute inset-[-29.61%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.4688 8.46878">
            <path d="M6.8938 6.89378L1.575 1.575" id="Vector" stroke="var(--stroke-0, #E36559)" strokeLinecap="round" strokeWidth="3.15" />
          </svg>
        </div>
      </div>
    </div>
...
function Button3() {
  return (
    <div className="bg-[#e36559] relative rounded-[100px] shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[4px] relative size-full">
...
function ButtonsContainer2() {
  return (
    <div className="absolute content-stretch flex h-[28px] items-center justify-between left-[24px] right-[24px] top-[223px]" data-name="buttons container">
      <ButtonContainer2 />
      <ButtonContainer3 />
    </div>
  );
...
export default function ConfirmReset() {
  return (
    <div className="relative size-full" data-name="Confirm Reset">
      <App />
      <PopUp />
    </div>
  );
