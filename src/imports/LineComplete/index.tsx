import svgPaths from "./svg-7vb9487rsn";
...
function PopUpTitle() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="pop up title">
      <p className="[word-break:break-word] font-['Quicksand:Bold',sans-serif] font-bold leading-[26px] relative shrink-0 text-[#2b2b23] text-[16px] text-center whitespace-nowrap">That’s a Bingo! ✨</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full">
      <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#2b2b23] text-[12px] text-center w-full">{`Great progress! Let's see if you can turn this line into a fully stamped board.`}</p>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#657652] flex-[1_0_0] min-w-px relative rounded-[100px]" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center justify-center px-[14px] py-[6px] relative size-full">
          <p className="[word-break:break-word] font-['Quicksand:SemiBold',sans-serif] font-semibold leading-[18px] relative shrink-0 text-[#faf6f0] text-[12px] text-center whitespace-nowrap">Challenge Accepted</p>
        </div>
      </div>
    </div>
  );
...
export default function LineComplete() {
  return (
    <div className="bg-[#faf6f0] relative size-full" data-name="Line Complete">
      <AppContainer />
      <PopUp />
    </div>
  );
